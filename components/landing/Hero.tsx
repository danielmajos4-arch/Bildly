  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#059669_1px,transparent_1px),linear-gradient(to_bottom,#059669_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_110%)] opacity-[0.03]" />
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
        ...
        <ScaleIn delay={0.1}>
          <div className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-full bg-primary/10 text-primary text-[10px] sm:text-xs md:text-sm font-medium mb-6 sm:mb-8 max-w-full min-w-0">
            <Feather className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 shrink-0" aria-hidden />
