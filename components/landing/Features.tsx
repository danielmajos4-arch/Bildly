...
import { Zap, Fingerprint, Globe, Star } from "lucide-react";
          ...
          {[
            ...
            <StaggerItem key={stat.label}>
              <div className="text-center min-w-0 max-w-full">
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-1 sm:mb-2 break-words flex items-center justify-center gap-1">{stat.value}{"hasStar" in stat && stat.hasStar && <Star className="w-5 h-5 sm:w-6 sm:h-6 fill-primary text-primary" />}</div>
